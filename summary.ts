...
// Narrowing
if (typeof uValue2 === 'string') {
  uValue2.toUpperCase(); // works!
}
...
function getValueStringBetter(values: Values, key: keyof Values) {
  return values[key]; // number
}
...
function getValueStringBetter2(key: keyof typeof values2) {
  return values2[key]; // number
}
